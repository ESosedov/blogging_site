                ...
                <a href="#" class="dropdown-item">
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p class="text-sm">Хватит это терпеть...</p>
                ...
                <a href="#" class="dropdown-item">
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p class="text-sm">Есть отличное предложение...</p>
                            <p class="text-sm text-muted"><i class="far fa-clock mr-1"></i> 4 Hours Ago</p>
                        </div>
                    </div>
                    <!-- Message End -->
                ...
                <a href="#" class="dropdown-item">
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p class="text-sm">Ты работать собираешься?..</p>
                            <p class="text-sm text-muted"><i class="far fa-clock mr-1"></i> 4 Hours Ago</p>
                        </div>
                    </div>
                    <!-- Message End -->
...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info">
                <a href="#" class="d-block">Молли Пес</a>
            </div>
        </div>
